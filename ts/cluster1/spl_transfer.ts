...
// Recipient address
const to = new PublicKey("3KQh4rmx2p6S8ML45sgGwT4EYqmfqwj7ciwg58RufAvN");
...
(async () => {
    try {
        ...
        const tx = await transfer(connection, keypair, fromAta.address, toAta.address, keypair, 10 * token_decimals)
        console.log(`txid: ${tx}`)
    } catch (e) {
